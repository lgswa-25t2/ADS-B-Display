...
#define FLIGHT_TRACK_HISTORY_COUNT   100
...
typedef struct
{
	...
	double              VerticalRate;
	int                 SpriteImage;
	// To show flight track
	double              PrevLatitude[FLIGHT_TRACK_HISTORY_COUNT];
	double              PrevLongitude[FLIGHT_TRACK_HISTORY_COUNT]; 
	double              PrevAltitude[FLIGHT_TRACK_HISTORY_COUNT];
